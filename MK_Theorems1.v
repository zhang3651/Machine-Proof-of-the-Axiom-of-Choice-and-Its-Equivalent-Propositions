(**********************************************************************)
(* This is part of MK_The1, it is distributed under the terms of the  *)
...
Lemma lem167a : ∀ r x f, WellOrdered r P[x] -> Function1_1 f
  -> dom(f) = x -> ran(f) = P[x]
  -> WellOrdered \{\ λ u v, Rrelation f[u] r f[v] \}\ x.
Proof.
